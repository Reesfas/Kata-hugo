    ...
    "paths": {
        ...
        "/api/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Информация о пользователе для входа",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "Пользователь не найден или неверные учетные данные",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/register": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Успешная регистрация, возвращает сообщение",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
